...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'materias_recordacademico', (
            ...
            ('nota', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
    ...
    models = {
        ...
        u'materias.recordacademico': {
            ...
            'nota': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
